...
import 'review_answers_gaps.dart';
import 'package:provider/provider.dart';
import 'play_gaps_activity.dart';

class ResultsGaps extends StatefulWidget {
  final ActivityReview activityReview;
  final GapsActivity gapsActivity;

  ResultsGaps({
    required this.gapsActivity,
    required this.activityReview
  });

  @override
  State<ResultsGaps> createState() => _ResultsGapsState();
}

class _ResultsGapsState extends State<ResultsGaps> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    widget.gapsActivity.isRated == false
                        ? ElevatedButton(
                      ...
                      child: OutlinedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ReviewAnswersGaps(gapsActivity: widget.gapsActivity), // Usamos el operador ! para indicar que no es nulo
                            ),
                          );
                        },
                        child: Text(
                      ...
                      child: OutlinedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PlayGapsActivity(gapsActivity: widget.gapsActivity), // Usamos el operador ! para indicar que no es nulo
                            ),
                          );
                        },
                        child: Text(
