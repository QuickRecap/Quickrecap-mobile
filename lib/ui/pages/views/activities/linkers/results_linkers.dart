...
import 'review_answers_linkers.dart';
import 'package:provider/provider.dart';
import 'play_linkers_activity.dart';

class ResultsLinkers extends StatefulWidget {
  final ActivityReview activityReview;
  final LinkersActivity linkersActivity;

  ResultsLinkers({
    required this.linkersActivity,
    required this.activityReview
  });

  @override
  State<ResultsLinkers> createState() => _ResultsLinkersState();
}

class _ResultsLinkersState extends State<ResultsLinkers> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  widget.linkersActivity.isRated == false
                      ? ElevatedButton(
                    ...
                    child: OutlinedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ReviewAnswersLinkers(linkersActivity: widget.linkersActivity), // Usamos el operador ! para indicar que no es nulo
                          ),
                        );
                      },
                      child: Text(
                    ...
                    child: OutlinedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PlayLinkersActivity(linkersActivity: widget.linkersActivity), // Usamos el operador ! para indicar que no es nulo
                          ),
                        );
                      },
                      child: Text(
