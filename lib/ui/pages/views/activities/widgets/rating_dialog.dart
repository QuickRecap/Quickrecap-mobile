    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Container(
          ...
          child: Form( // Asegúrate de envolverlo dentro de un Form
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  maxLines: 3,
                  // El validador no debe exigir un comentario
                  validator: (value) {
                    return null; // No requiere validación ya que es opcional
                  },
                ),
                const SizedBox(height: 16),
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          if (success) {
                            ...
                            _showSuccessSnackBar('Actividad calificada exitosamente.');
                          } else {
