...
class CreateLinkersDialog extends StatefulWidget {
  ...
  @override
  State<CreateLinkersDialog> createState() => _CreateLinkersDialogState();
...
class _CreateLinkersDialogState extends State<CreateLinkersDialog> {
  LinkersActivity? linkersActivity;
                    ...
                    child: ElevatedButton(
                      onPressed: _isLoading
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          final linkersProvider = Provider.of<LinkersProvider>(context, listen: false);

                          try {
                            linkersActivity = await linkersProvider.createLinkers(
                            ...
                            setState(() {
                              _isConfigView = false;
                              _isSuccess = linkersActivity != null;
                            });
                          } catch (e) {
                            setState(() {
                              _isConfigView = false;
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (_isSuccess && linkersActivity != null) {
