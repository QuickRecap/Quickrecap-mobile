...
class CreateScreen extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.pushNamed(context, '/select_pdf'); // Navega a la pantalla de selección de PDF
                  },
                  child: Container(
                ...
                // Añadir espacio extra al final para asegurar que el último elemento sea visible
  ...
  Widget _buildModeOption({required IconData icon, required String title, required String description}) {
    return Container(
